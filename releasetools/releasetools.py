def FullOTA_InstallEnd(info):
    ...
    info.script.AppendExtra('run_program("/sbin/ln", "-s", "/vendor/lib/egl/libGLES_mali.so", "/vendor/lib/libGLES_mali.so");');
    ...
    info.script.AppendExtra('run_program("/sbin/ln", "-s", "/vendor/lib64/egl/libGLES_mali.so", "/vendor/lib64/libGLES_mali.so");');
    ...
    info.script.AppendExtra('run_program("/sbin/rm", "-r", "/vendor/etc/init/rild.legacy.rc");');
...
def FullOTA_PostValidate(info):
    ...
    info.script.AppendExtra('run_program("/sbin/e2fsck", "-fy", "/dev/block/platform/11120000.ufs/by-name/SYSTEM");');
    info.script.AppendExtra('run_program("/sbin/e2fsck", "-fy", "/dev/block/platform/11120000.ufs/by-name/VENDOR");');
    info.script.AppendExtra('run_program("/sbin/resize2fs", "/dev/block/platform/11120000.ufs/by-name/VENDOR");');
    info.script.AppendExtra('run_program("/sbin/e2fsck", "-fy", "/dev/block/platform/11120000.ufs/by-name/VENDOR");');
